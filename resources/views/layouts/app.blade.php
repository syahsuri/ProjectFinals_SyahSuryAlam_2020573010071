    ...
    <div class="bg-image with-3d-shadow" style="background-image: url('https://mdbcdn.b-cdn.net/img/Photos/Others/images/76.webp');">
        ...
        <body>
            <div id="app">
                <div class="container">
                    <nav class="navbar navbar-expand-md shadow-sm mt-1 px-4" style="background-color: #18181b ">
                ...
                <div class="container">
                    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                        <div class="col-md-4 d-flex align-items-center">
                            ...
                            <span class="mb-3 mb-md-0 text-white">&copy; 2022 PNL, Syah Sury Alam</span>
                        </div>
