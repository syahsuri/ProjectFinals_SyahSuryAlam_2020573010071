    ...
    <body>
        <div id="app">
            <div class="container">
                <nav class="navbar navbar-expand-md shadow-sm mt-3 px-4" style="background-color: #18181b ">
            ...
            <div class="container">
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                    <div class="col-md-4 d-flex align-items-center">
                        ...
                        <span class="mb-3 mb-md-0 text-muted">&copy; 2022 PNL, Syah Sury Alam</span>
                    </div>
